...
const projects = [
  {
    ...
    image: '/project-alvor.png', alt: 'Página inicial do site da Alvor Café'
  },
  {
    ...
    image: '/project-rkl.png', alt: 'Página inicial do site da RKL Acabamentos'
  },
  {
    ...
    image: '/project-maggiori.png', alt: 'Página inicial do site da Maggiori Alpha'
  }
];
          ...
          <article className="vpa-project-feature" key={project.name}>
            <div className="vpa-project-visual">
              ...
              <div className="vpa-project-screenshot-wrap">
                <img className="vpa-project-screenshot" src={project.image} alt={project.alt} loading="lazy" />
              </div>
            </div>
